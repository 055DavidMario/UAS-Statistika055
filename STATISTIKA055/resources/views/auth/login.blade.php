                            ...
                            <div class="flex -mx-3">
                                <div class="flex items-center justify-end mt-4">
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="ml-4 border-black/60 border-2 p-1 rounded-md w-auto text-sm hover:bg-white text-gray-700 dark:text-gray-500 underline">Register</a>
                                    @endif
                                </div>
                            </div>
                        </div>
